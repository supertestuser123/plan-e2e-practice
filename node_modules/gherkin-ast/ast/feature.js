...
const debug = (0, debug_1.getDebugger)("Feature");
/**
 * Model for Feature
 */
class Feature extends uniqueObject_1.UniqueObject {
    static parse(obj, comments) {
        ...
        const feature = new Feature(keyword, name, description, language);
        feature.precedingComment = comments === null || comments === void 0 ? void 0 : comments.parseComment(location, (_b = tags === null || tags === void 0 ? void 0 : tags[tags.length - 1]) === null || _b === void 0 ? void 0 : _b.location);
        feature.tagComment = comments === null || comments === void 0 ? void 0 : comments.parseTagComment(tags);
        feature.tags = tag_1.Tag.parseAll(tags, comments);
        let firstLocation = null;
        feature.elements = children.map((child) => {
            var _a, _b, _c, _d;
            if ((0, gherkinObject_1.isGherkinRule)(child)) {
                if (!firstLocation) {
                    firstLocation = child.rule.location;
                }
                return rule_1.Rule.parse(child, comments);
            }
        ...
        feature.descriptionComment = comments === null || comments === void 0 ? void 0 : comments.parseCommentBetween(location, firstLocation);
        debug("parse(this: {keyword: '%s', name: '%s', description: '%s', language: '%s', " +
            "precedingComment: '%s', tagComment: '%s', desctiptionComment: '%s', " +
            "tags: %d, elements: %d})", feature.keyword, feature.name, feature.description, feature.language, (_c = feature.precedingComment) === null || _c === void 0 ? void 0 : _c.text, (_d = feature.tagComment) === null || _d === void 0 ? void 0 : _d.text, (_e = feature.descriptionComment) === null || _e === void 0 ? void 0 : _e.text, (_f = feature.tags) === null || _f === void 0 ? void 0 : _f.length, (_g = feature.elements) === null || _g === void 0 ? void 0 : _g.length);
        return feature;
    }
    constructor(keyword, name, description, language = "en") {
        var _a, _b, _c, _d, _e;
        super();
        debug("constructor(keyword: '%s', name: '%s', description: '%s', language: '%s')", keyword, name, description, language);
        ...
        debug("constructor(this: {keyword: '%s', name: '%s', description: '%s', language: '%s', " +
            "precedingComment: '%s', tagComment: '%s', desctiptionComment: '%s', " +
            "tags: %d, elements: %d})", this.keyword, this.name, this.description, this.language, (_a = this.precedingComment) === null || _a === void 0 ? void 0 : _a.text, (_b = this.tagComment) === null || _b === void 0 ? void 0 : _b.text, (_c = this.descriptionComment) === null || _c === void 0 ? void 0 : _c.text, (_d = this.tags) === null || _d === void 0 ? void 0 : _d.length, (_e = this.elements) === null || _e === void 0 ? void 0 : _e.length);
    }
    clone() {
        var _a, _b, _c, _d, _e;
        debug("clone(this: {keyword: '%s', name: '%s', description: '%s', language: '%s', " +
            "precedingComment: '%s', tagComment: '%s', desctiptionComment: '%s', " +
            "tags: %d, elements: %d})", this.keyword, this.name, this.description, this.language, (_a = this.precedingComment) === null || _a === void 0 ? void 0 : _a.text, (_b = this.tagComment) === null || _b === void 0 ? void 0 : _b.text, (_c = this.descriptionComment) === null || _c === void 0 ? void 0 : _c.text, (_d = this.tags) === null || _d === void 0 ? void 0 : _d.length, (_e = this.elements) === null || _e === void 0 ? void 0 : _e.length);
        const feature = new Feature(this.keyword, this.name, this.description, this.language);
        feature.tags = (0, common_1.cloneArray)(this.tags);
        feature.elements = (0, common_1.cloneArray)(this.elements);
